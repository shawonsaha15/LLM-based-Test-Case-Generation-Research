class TestPartitionList(unittest.TestCase):
    ...
    def test_partition_list_single_element_less_than_x(self):
        head = ListNode(3)
        result = partition_list(head, 5)
        self.assertEqual(result.val, 3)
        self.assertIsNone(result.next)

    def test_partition_list_single_element_greater_than_x(self):
        head = ListNode(7)
        result = partition_list(head, 5)
        self.assertEqual(result.val, 7)
        self.assertIsNone(result.next)

    def test_partition_list_multiple_elements_all_less_than_x(self):
        head = ListNode(3)
    ...
    def test_partition_list_multiple_elements_all_greater_than_x(self):
        head = ListNode(7)
    ...
    def test_partition_list_multiple_elements_mixed(self):
        head = ListNode(1)
