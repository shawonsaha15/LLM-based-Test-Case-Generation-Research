...
class TestLetterCombinations(unittest.TestCase):
    ...
    def test_single_digit_nonexistent_digit(self):
        self.assertEqual(letter_combinations("a"), [])

    def test_multiple_digits(self):
        self.assertEqual(letter_combinations("234"), ["adg", "adh", "adi", "aeg", "aeh", "aei", "afg", "afh", "afi", "bdg", "bdh", "bdi", "beg", "beh", "bei", "bfg", "bfh", "bfi", "cdg", "cdh", "cdi", "ceg", "ceh", "cei", "cfg", "cfh", "cfi"])

    def test_multiple_digits_with_zero(self):
        self.assertEqual(letter_combinations("20"), [])

    def test_multiple_digits_with_nonexistent_digit(self):
